 ...
 * @author Lissette
 */
public class AutoresForm extends javax.swing.JInternalFrame {
    Autor depto = new Autor();
    DAOAutor daoDepto = new DAOAutor();
    /**
    ...
    public void tabla() {
        ...
        List ls;
        try {
            ls = daoDepto.mostrarAutores();
            for (int i = 0; i < ls.size(); i++) {
                depto = (Autor) ls.get(i);
                obj[0] = depto.getAutorID();
                obj[1] = depto.getNombreAutor();
                tabla.addRow(obj);
            }
            ls = daoDepto.mostrarAutores();
            this.tbl_autores.setModel(tabla);
        } catch (Exception e) {
    ...
    public void llenarTabla() {
        int fila = this.tbl_autores.getSelectedRow();
        this.txt_codigo.setText(String.valueOf(this.tbl_autores.getValueAt(fila, 0)));
        this.txt_nombre.setText(String.valueOf(this.tbl_autores.getValueAt(fila, 1)));
    }
    public void agregar() throws Exception {
        //depto.setCodigoDepartamento(Integer.parseInt(this.txt_codigo.getText()));
        depto.setNombreAutor(this.txt_nombre.getText());
        daoDepto.crearAutor(depto);
    ...
    public void actualizar() {
        try {
            depto.setAutorID(Integer.parseInt(this.txt_codigo.getText()));
            depto.setNombreAutor(this.txt_nombre.getText());
            int decision = JOptionPane.showConfirmDialog(this, "Desea modificar al autor", 
            "Modificar autor", JOptionPane.YES_NO_OPTION);
            if (decision == 0) {
                daoDepto.actualizarAutor(depto);
    ...
    public void eliminar() {
        try {
            depto.setAutorID(Integer.parseInt(this.txt_codigo.getText()));
            int decision = JOptionPane.showConfirmDialog(this, "Desea eliminar autor", 
            "Eliminar autor", JOptionPane.YES_NO_OPTION);
            if (decision == 0) {
                daoDepto.eliminarDepartamento(depto);
